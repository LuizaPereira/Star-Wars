...
export class MovieDetailComponent implements OnInit, OnDestroy {
  ...
  getMovie(): void {
    ...
    this.detailSubscription = this._movies
      .getMovies()
  ...
  getCharacters(): void {
    ...
    this.charactersUrl.map(data => {
      ...
      this._characters.getCharacterByUrl(data).subscribe((char: Character) => {
  ...
  getPlanets(): void {
    ...
    this.planetsUrl.map(data => {
      ...
      this._planets.getPlanetByUrl(data).subscribe((planet: Planet) => {
  ...
  getSpecies(): void {
    ...
    this.speciesUrl.map(data => {
      ...
      this._species.getSpecieByUrl(data).subscribe((specie: Specie) => {
  ...
  getStarships(): void {
    ...
    this.starshipsUrl.map(data => {
      ...
      this._starships.getStarshipByUrl(data).subscribe((starship: Starship) => {
  ...
  getVehicles(): void {
    ...
    this.vehiclesUrl.map(data => {
      ...
      this._vehicles.getVehicleByUrl(data).subscribe((vehicle: Vehicle) => {
